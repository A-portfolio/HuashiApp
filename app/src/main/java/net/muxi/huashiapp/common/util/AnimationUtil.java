...
public class AnimationUtil{
    ...
    public static void crossFadeView(View showView,View hideView){
        crossFadeView(showView,hideView,ANIMATION_DURATION_SHORT);
    }

    public static void crossFadeView(View showView,View hideView,int duration){
...
//    public static void fadeOutView(View)
}
