...
public final class SPUtils {
    ...
    private SPUtils(final String spName) {
        sp = Global.getApplication().getSharedPreferences(spName, Context.MODE_PRIVATE);
    }

    private SPUtils(final String spName, final int mode) {
        sp = Global.getApplication().getSharedPreferences(spName, mode);
    }
